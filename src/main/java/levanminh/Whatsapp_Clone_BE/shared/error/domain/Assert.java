package levanminh.Whatsapp_Clone_BE.shared.error.domain;
...
/**
    lớp tiện ích Assert để xác thực đầu vào trong ứng dụng Java của mình. Lớp này giúp kiểm tra các điều kiện
    như giá trị không null, không trống, không âm, nằm trong khoảng giá trị nhất định, v.v.
    Đây là cách tiếp cận tốt để đảm bảo dữ liệu đầu vào hợp lệ trước khi thực hiện các xử lý tiếp theo.
 */
